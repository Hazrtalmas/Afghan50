...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Termux Command
\033[1;37m Facebook:          Termux Command
\033[1;37m Github  :            Termux.9
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back afghan Menu ")
        exit()
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL')
    else:
