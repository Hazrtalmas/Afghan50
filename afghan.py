...
════════════════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :-  Termux
\033[1;32m  • \033[1;37m GitHub     :-  AFG
...
def Main_VENOM():
        ...
        if opt1 == "1": method()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL');Main_VENOM()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL');Main_VENOM()
 
            if d == '0':Main_VENOM()
            else:line();print('\033[1;33m [•]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_VENOM()
        elif opt1 == "3":
            clear();print(' [\033[1;32m1\033[97;1m] Join My Account');print(' [\033[1;32m2\033[97;1m] Join Facebook Group');print(' [\033[1;32m0\033[97;1m] \033[1;31mBack Main Menu');line()
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL');Main_VENOM()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL');Main_VENOM()
            if d == '0':Main_VENOM()
